#ifndef __CONNECTONENET_H__
#define __CONNECTONENET_H__
...
#define DEVICE_ID  "1026301742"						//用户根据自己的实际情况决定
#define AUTH_KEY   "CQGBtAbN5qPrwI5PnVHNSvVmtNs="	//用户根据自己的实际情况决定
