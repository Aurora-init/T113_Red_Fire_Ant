...
typedef struct __gngga__
{
    UINT time;         					/* gps定位时间 */
    UINT latitude;    					/* 纬度整数 */
	UINT latitude_x;    				/* 纬度小数 */
	
    UINT longitude;   					/* 经度整数 */
	UINT longitude_x;   				/* 经度小数 */
    ...
    UINT Geoidal_Separation; 		    /* 大地水准位间距整数 */
	UINT Geoidal_Separation_x; 		    /* 大地水准位间距小数 */
	char str;

	/* 结果区域 */
	char result_longitude;				/* 经度整数 */
	char result_latitude;·				/* 维度整数 */
} GNGGA;
