...
{                                                                \
  ...
  P1DIR |= BV(2);                                                \
                                                                 \
  LED1_DDR |= LED1_BV;  /* P0_4 */                               \
  /* LED2_DDR |= LED2_BV; */ /* P0_5 */                          \
  /* LED3_DDR |= LED3_BV; */ /* P0_6 */                          \
                                                                 \
  /* Set PA/LNA HGM control P0_0 */                              \
  P0DIR |= BV(0);                                                \
                                                                 \
                                                                 \
  /* setup RF frontend if necessary */                           \
...
/* ----------- LED's ---------- */
  ...
  #define HAL_STATE_LED1()          (LED1_POLARITY (LED1_SBIT))
  #define HAL_STATE_LED2()          0//(LED2_POLARITY (LED2_SBIT))
  #define HAL_STATE_LED3()          0//(LED3_POLARITY (LED3_SBIT))
